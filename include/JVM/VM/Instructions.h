...
constexpr Instruction lload_0("lload_0", 30);
constexpr Instruction lload_1("lload_1", 31);
constexpr Instruction lload_2("lload_2", 32);
constexpr Instruction lload_3("lload_3", 33);
constexpr Instruction fload_0("fload_0", 34);
constexpr Instruction fload_1("fload_1", 35);
constexpr Instruction fload_2("fload_2", 36);
constexpr Instruction fload_3("fload_3", 37);
constexpr Instruction dload_0("dload_0", 38);
constexpr Instruction dload_1("dload_1", 39);
constexpr Instruction dload_2("dload_2", 40);
constexpr Instruction dload_3("dload_3", 41);
constexpr Instruction aload_0("aload_0", 42);
constexpr Instruction aload_1("aload_1", 43);
constexpr Instruction aload_2("aload_2", 44);
constexpr Instruction aload_3("aload_3", 45);
constexpr Instruction iaload("iaload", 46);
constexpr Instruction laload("laload", 47);
constexpr Instruction faload("faload", 48);
constexpr Instruction daload("daload", 49);
constexpr Instruction aaload("aaload", 50);
constexpr Instruction baload("baload", 51);
constexpr Instruction caload("caload", 52);
constexpr Instruction saload("saload", 53);
